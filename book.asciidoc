...
karma points a character can have, and possibly reducing the number of
experience points awarded to the players, forcing them to convert karma into
XP.
...
You can convert 10 karma points into 1 experience point.  This can only be done
once per session.
...
A character starts with 2 items from the Weapons table, 1 item from the Armors
table, and 4 items from the Gear tables.
...
Equipment Slots::
A character has 8 equipment slots, meaning that she can carry 8 "relevant" items.
Items that are not essential to the game (undergarments, grooming equipment, etc.)
or that have negleble weight (maps, drawings, letters, jewelry) do not not count.
...
During a combat round, you have 5 Steps and 1 Action. You can take them in any order.
You can take 3 Step action, your main Action, and then up to 2 more Step actions.

Steps::
The most common use of a Step is to move 1 square in any direction, but there are 
more uses than that:
* You can expend 3 Steps to get up from prone position.
* You can exchange your Action to get 5 more Steps.
* You can expend 5 Steps to sustain a spell.
